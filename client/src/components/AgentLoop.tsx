...
export function AgentLoop() {
  ...
  useEffect(() => {
    if (!llmAgents) {
      if (godTimer.current) { window.clearInterval(godTimer.current); godTimer.current = null }
      return
    }
    ...
    return () => { if (godTimer.current) { window.clearInterval(godTimer.current); godTimer.current = null } }
